...
public class Test : MonoBehaviour
{
    ...
    [SerializeField] float targetLine = 332;
    ...
    void Start()
    {
        targetText.text = targetLine.ToString();

        random = new System.Random();
        ga = new GeneticAlgorithm<float>(populationSize, (int)targetLine, random, GetRandomCharacter, FitnessFunction, elitism, mutationRate);
    }
    ...
    private float GetRandomCharacter()
    {
